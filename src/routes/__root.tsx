...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Build custom websites from detailed prompts." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Kailo" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Kailo — Premium Instrument Accessories" },
      { name: "description", content: "Build custom websites from detailed prompts." },
      { name: "twitter:description", content: "Build custom websites from detailed prompts." },
