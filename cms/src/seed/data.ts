 ...
 *
 *   frontend/src/lib/products.ts        → CATEGORIES, PRODUCTS
 *   frontend/src/routes/index.tsx       → HOME_PAGE
 *   frontend/src/routes/about.tsx       → ABOUT_PAGE
 *   frontend/src/routes/gallery.tsx     → GALLERY_IMAGES
 *   frontend/src/routes/contact.tsx     → CONTACT_PAGE
 *   frontend/src/components/Footer.tsx  → GLOBAL (footer half)
 *   frontend/src/components/Navbar.tsx  → GLOBAL (nav half)
 *
 ...
 *
 * The originals are gone from `frontend/src/assets` and from the Unsplash
